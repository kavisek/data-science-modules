...
class Vectorize(luigi.Task):
    # TODO: create a parameter for the input directory
    # TODO: create a Boolean parameter for evaluation
    ...
    def run(self):
        ...
        if self.evaluate:
            ...
            # TODO: output test split feature matrix
            # TODO: output test split labels
    ...
    def output(self):
        ...
        if self.evaluate:
            # TODO: append two LocalTargets, one for x_test and one for y_test
...
class TrainClassifier(luigi.Task):
  ...
  # TODO: create a Float parameter for the NB hyperparameter
  ...
  def output(self):
    # TODO: create a LocalTarget for the model pickle
    pass
...
class EvaluateModel(luigi.Task):
    ...
    def requires(self):
        # TODO: define TrainClassifier and Vectorize stages as dependencies
        pass
