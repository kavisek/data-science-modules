...
Select count(*) as NumofStocks, natname from stockTrans group by natname;
Select avg(stkpe), natname from stocktrans group by natname; 
Select max(stkpe), natname from stocktrans group by natcode; 
