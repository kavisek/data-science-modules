...
-- -----------------------------------------------------
-- Table `db_2`.`Department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_2`.`Department` (
...
CREATE TABLE IF NOT EXISTS `db_2`.`Item` (
  ...
  CONSTRAINT `fk_Item_Department1`
    ...
    REFERENCES `db_2`.`Department` (`department_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
LOAD DATA LOCAL INFILE "C:/Users/Keith/Desktop/BUS 464/Project/key.csv"
into TABLE `key`
...
LOAD DATA LOCAL INFILE "C:/Users/Keith/Desktop/BUS 464/Project/train.csv"
into TABLE `train`
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
ignore 1 lines;
...
LOAD DATA LOCAL INFILE "C:/Users/Keith/Desktop/BUS 464/Project/weather.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/Keith/Desktop/store.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/Keith/Desktop/item.csv"
into TABLE `itemtemp`
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
ignore 1 lines;
...
LOAD DATA LOCAL INFILE "C:/Users/Keith/Desktop/department.csv"
