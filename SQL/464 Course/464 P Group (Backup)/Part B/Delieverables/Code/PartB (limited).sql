...
#We set limits within the code to have a faster response with local servers and remote machines.
#The limit for each indivitual imported table is 100 lines, you can remove the "limit 100" to do a large test
#but you will require a very powerful machine since thes weather event table is so large
