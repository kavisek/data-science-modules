...
-- Schema db_kavi
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `db_kavi` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `db_kavi` ;

-- -----------------------------------------------------
-- Table `db_kavi`.`station`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`station` (
...
-- Table `db_kavi`.`store`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`store` (
  ...
  CONSTRAINT `fk_Store_Station`
    ...
    REFERENCES `db_kavi`.`Station` (`station_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_kavi`.`department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`department` (
...
-- Table `db_kavi`.`Item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`item` (
  ...
  CONSTRAINT `fk_Item_Department1`
    ...
    REFERENCES `db_kavi`.`Department` (`department_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_kavi`.`inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`inventory` (
  ...
  CONSTRAINT `fk_Item_Store1`
    ...
    REFERENCES `db_kavi`.`Store` (`store_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Item_Product1`
    FOREIGN KEY (`item_id`)
    REFERENCES `db_kavi`.`Item` (`item_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `db_kavi`.`sale`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`sale` (
...
-- -----------------------------------------------------
-- Table `db_kavi`.`weather event`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`weather event` (
...
-- -----------------------------------------------------
-- Table `db_kavi`.`iine_Item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_kavi`.`line_Item` (
...
REFERENCES `db_kavi`.`Sale` (`sale_id`);
